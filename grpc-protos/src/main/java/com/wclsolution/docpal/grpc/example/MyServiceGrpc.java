...
public final class MyServiceGrpc {
  ...
  public static final java.lang.String SERVICE_NAME = "com.wclsolution.docpal.grpc.example.MyService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.wclsolution.docpal.grpc.example.HelloRequest,
      com.wclsolution.docpal.grpc.example.HelloReply> getSayHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SayHello",
      requestType = com.wclsolution.docpal.grpc.example.HelloRequest.class,
      responseType = com.wclsolution.docpal.grpc.example.HelloReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.wclsolution.docpal.grpc.example.HelloRequest,
      com.wclsolution.docpal.grpc.example.HelloReply> getSayHelloMethod() {
    io.grpc.MethodDescriptor<com.wclsolution.docpal.grpc.example.HelloRequest, com.wclsolution.docpal.grpc.example.HelloReply> getSayHelloMethod;
      ...
      synchronized (MyServiceGrpc.class) {
        if ((getSayHelloMethod = MyServiceGrpc.getSayHelloMethod) == null) {
          MyServiceGrpc.getSayHelloMethod = getSayHelloMethod =
              io.grpc.MethodDescriptor.<com.wclsolution.docpal.grpc.example.HelloRequest, com.wclsolution.docpal.grpc.example.HelloReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "SayHello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.wclsolution.docpal.grpc.example.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.wclsolution.docpal.grpc.example.HelloReply.getDefaultInstance()))
  ...
  public interface AsyncService {
     ...
     * </pre>
     */
    default void sayHello(com.wclsolution.docpal.grpc.example.HelloRequest request,
        io.grpc.stub.StreamObserver<com.wclsolution.docpal.grpc.example.HelloReply> responseObserver) {
  ...
  public static final class MyServiceStub
     ...
     * </pre>
     */
    public void sayHello(com.wclsolution.docpal.grpc.example.HelloRequest request,
        io.grpc.stub.StreamObserver<com.wclsolution.docpal.grpc.example.HelloReply> responseObserver) {
  ...
  public static final class MyServiceBlockingStub
     ...
     * </pre>
     */
    public com.wclsolution.docpal.grpc.example.HelloReply sayHello(com.wclsolution.docpal.grpc.example.HelloRequest request) {
  ...
  public static final class MyServiceFutureStub
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.wclsolution.docpal.grpc.example.HelloReply> sayHello(
        com.wclsolution.docpal.grpc.example.HelloRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SAY_HELLO:
          serviceImpl.sayHello((com.wclsolution.docpal.grpc.example.HelloRequest) request,
              (io.grpc.stub.StreamObserver<com.wclsolution.docpal.grpc.example.HelloReply>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.wclsolution.docpal.grpc.example.HelloRequest,
              com.wclsolution.docpal.grpc.example.HelloReply>(
  ...
  private static abstract class MyServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.wclsolution.docpal.grpc.example.MyServiceOuterClass.getDescriptor();
    }
